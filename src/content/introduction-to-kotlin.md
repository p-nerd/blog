...
date: 2022-10-15
desc: "JVM-এর জন্য একটি আধুনিক প্রোগ্রামিং ভাষা | কটলিন (Kotlin) একটি স্ট্যাটিকালি টাইপ করা মাল্টি-প্যারাডাইম প্রোগ্রামিং ল্যাঙ্গুয়েজ যা জাভা-এর একটি ভাল বিকল্প হিসাবে ডিজাইন করা হয়েছে। জাভার মতো এটি জাভা ভার্চুয়াল মেশিনে চালিত বাইটকোডগুলিতে কম্পাইল করে, তবে কোটলিন আধুনিক ডেভেলপারদের পছন্দের আরও সংক্ষিপ্ত সিনট্যাক্স এবং ল্যাঙ্গুয়েজ ফিচার সরবরাহ করে। যেমন: টাইপ ইনফারেন্স, ফাংশনাল প্যার্টান, নাল সেফটি এবং আরও অনেক কিছু। এটি 2011 সালে Jetbrains দ্বারা ঘোষণা করা হয়েছিল এবং 2016 সালে এর প্রথম স্ট্যাবল ভার্শন প্রকাশ করা হয়।"

tags: ["programming", "jvm", "kotlin"]
categories: ["Code"]
series: ["software-development"]

img: /img/introduction-to-kotlin.png
imgWidth: 500
imgHeight: 500
---
